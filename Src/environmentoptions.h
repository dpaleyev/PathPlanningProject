...
public:
  ...
  EnvironmentOptions();
  int metrictype; // Can be chosen Euclidean, Manhattan, Chebyshev and Diagonal
                  // distance
  ...
  bool cutcorners;    // Option that allows to make diagonal moves, when one
                   // adjacent cell is untraversable
