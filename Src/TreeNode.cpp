...
void TreeNode::findPaths(ILogger *Logger, const Map &Map,
...
void TreeNode::updatePath(ILogger *Logger, const Map &Map,
                          const EnvironmentOptions &options, int agent_id) {
  Search search;
  SearchResult sr =
      search.startSearch(Logger, Map, options, agent_id, constraints[agent_id]);
