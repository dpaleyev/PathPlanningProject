...
bool Mission::getMap() { return map.getMap(fileName); }

bool Mission::getConfig() { return config.getConfig(fileName); }
...
void Mission::printSearchResultsToConsole() {
  ...
  if (hsr.totalCost != -1) {
    ...
    std::cout << "pathlength_scaled=" << hsr.totalCost * map.getCellSize()
              << std::endl;
  }
