...
bool Config::getConfig(const char *FileName) {
  ...
  if (value == CNS_SP_ST_BFS) {
  ...
  } else if (value == CNS_SP_ST_ASTAR || value == CNS_SP_ST_JP_SEARCH ||
             value == CNS_SP_ST_TH) {
    N = 7;
    SearchParams = new double[N];
    ...
    if (!element) {
      std::cout << "Warning! No '" << CNS_TAG_HW
                << "' tag found in algorithm section." << std::endl;
      ...
      if (SearchParams[CN_SP_HW] < 1) {
        std::cout << "Warning! Value of '" << CNS_TAG_HW
                  << "' tag is not correctly specified. Should be >= 1."
                  << std::endl;
        std::cout << "Value of '" << CNS_TAG_HW << "' was defined to 1."
                  << std::endl;
        SearchParams[CN_SP_HW] = 1;
    ...
    if (!element) {
      ...
      if (value == CNS_SP_MT_MANH)
        ...
        std::cout << "Warning! Value of'" << CNS_TAG_MT
                  << "' is not correctly specified." << std::endl;
        std::cout << "Value of '" << CNS_TAG_MT
                  << "' was defined to 'euclidean'" << std::endl;
        SearchParams[CN_SP_MT] = CN_SP_MT_EUCL;
      }
      if (SearchParams[CN_SP_ST] == CN_SP_ST_TH &&
          SearchParams[CN_SP_MT] != CN_SP_MT_EUCL) {
        std::cout
            << "Warning! This type of metric is not admissible for Theta*!"
            << std::endl;
      }
    }
    ...
    if (!element) {
      ...
      if (value == CNS_SP_BT_GMIN)
        ...
        std::cout << "Warning! Value of '" << CNS_TAG_BT
                  << "' is not correctly specified." << std::endl;
        std::cout << "Value of '" << CNS_TAG_BT << "' was defined to 'g-max'"
                  << std::endl;
        SearchParams[CN_SP_BT] = CN_SP_BT_GMAX;
    ...
    std::cout << "Error! Value of '" << CNS_TAG_ST
              << "' tag (algorithm name) is not correctly specified."
              << std::endl;
    std::cout << "Supported algorithm's names are: '" << CNS_SP_ST_BFS << "', '"
              << CNS_SP_ST_DIJK << "', '" << CNS_SP_ST_ASTAR << "', '"
              << CNS_SP_ST_TH << "', '" << CNS_SP_ST_JP_SEARCH << "'."
              << std::endl;
    return false;
  }
  ...
  if (!element) {
    ...
    if (check != "1" && check != "true" && check != "0" && check != "false") {
      std::cout << "Warning! Value of '" << CNS_TAG_AD
                << "' is not correctly specified." << std::endl;
      std::cout << "Value of '" << CNS_TAG_AD
                << "' was defined to default - true " << std::endl;
      SearchParams[CN_SP_AD] = 1;
  ...
  if (SearchParams[CN_SP_AD] == 0) {
    ...
    if (!element) {
      std::cout << "Warning! No '" << CNS_TAG_CC
                << "' element found in XML file." << std::endl;
      std::cout << "Value of '" << CNS_TAG_CC
                << "' was defined to default - false" << std::endl;
      SearchParams[CN_SP_CC] = 0;
    } else {
      std::string check;
      stream << element->GetText();
      ...
      stream.str("");
      if (check != "1" && check != "true" && check != "0" && check != "false") {
        std::cout << "Warning! Value of '" << CNS_TAG_CC
                  << "' is not correctly specified." << std::endl;
        std::cout << "Value of '" << CNS_TAG_CC
                  << "' was defined to default - false" << std::endl;
        SearchParams[CN_SP_CC] = 0;
    ...
    if (SearchParams[CN_SP_CC] == 0) {
      ...
      if (!element) {
        std::cout << "Warning! No '" << CNS_TAG_AS
                  << "' element found in XML file." << std::endl;
        std::cout << "Value of '" << CNS_TAG_AS
                  << "' was defined to default - false." << std::endl;
        SearchParams[CN_SP_AS] = 0;
      } else {
        std::string check;
  ...
  if (!element) {
    std::cout << "Warning! No '" << CNS_TAG_PC << "' element found in XML file."
              << std::endl;
    std::cout << "Value of '" << CNS_TAG_PC << "' was defined to default - true"
              << std::endl;
    ...
    if (check != "1" && check != "true" && check != "0" && check != "false") {
      std::cout << "Warning! Value of '" << CNS_TAG_PC
                << "' is not correctly specified." << std::endl;
      std::cout << "Value of '" << CNS_TAG_PC
                << "' was defined to default - true " << std::endl;
      HighSearchParams[CN_SP_PC] = 1;
    } else if (check == "1" || check == "true")
      HighSearchParams[CN_SP_PC] = 1;
  ...
  if (HighSearchParams[CN_SP_PC] == 0) {
    ...
    if (!element) {
      std::cout << "Warning! No '" << CNS_TAG_BP
                << "' element found in XML file." << std::endl;
      std::cout << "Value of '" << CNS_TAG_BP
                << "' was defined to default - true" << std::endl;
      ...
      if (check != "1" && check != "true" && check != "0" && check != "false") {
        std::cout << "Warning! Value of '" << CNS_TAG_BP
                  << "' is not correctly specified." << std::endl;
        std::cout << "Value of '" << CNS_TAG_BP
                  << "' was defined to default - true " << std::endl;
        HighSearchParams[CN_SP_BP] = 1;
  ...
  if (!element) {
    std::cout << "Warning! No '" << CNS_TAG_CR << "' element found in XML file."
              << std::endl;
    std::cout << "Value of '" << CNS_TAG_CR << "' was defined to default - true"
              << std::endl;
    ...
    if (check != "1" && check != "true" && check != "0" && check != "false") {
      std::cout << "Warning! Value of '" << CNS_TAG_CR
                << "' is not correctly specified." << std::endl;
      std::cout << "Value of '" << CNS_TAG_CR
                << "' was defined to default - true " << std::endl;
      HighSearchParams[CN_SP_CR] = 1;
    } else if (check == "1" || check == "true")
      HighSearchParams[CN_SP_CR] = 1;
  ...
  if (!element) {
    std::cout << "Warning! No '" << CNS_TAG_TR << "' element found in XML file."
              << std::endl;
    std::cout << "Value of '" << CNS_TAG_TR << "' was defined to default - true"
              << std::endl;
    ...
    if (check != "1" && check != "true" && check != "0" && check != "false") {
      std::cout << "Warning! Value of '" << CNS_TAG_TR
                << "' is not correctly specified." << std::endl;
      std::cout << "Value of '" << CNS_TAG_TR
                << "' was defined to default - true " << std::endl;
      HighSearchParams[CN_SP_TR] = 1;
    } else if (check == "1" || check == "true")
      HighSearchParams[CN_SP_TR] = 1;
  ...
  if (!options) {
    ...
    if (!element) {
      std::cout << "Warning! No '" << CNS_TAG_LOGLVL
                << "' tag found in XML file." << std::endl;
      std::cout << "Value of '" << CNS_TAG_LOGLVL
                << "' tag was defined to 'short log' (1)." << std::endl;
      LogParams[CN_LP_LEVEL] = CN_LP_LEVEL_SHORT_WORD;
    } else {
      ...
      else if (value == CN_LP_LEVEL_TINY_WORD ||
               value == CN_LP_LEVEL_TINY_VALUE)
        LogParams[CN_LP_LEVEL] = CN_LP_LEVEL_TINY_WORD;
      else if (value == CN_LP_LEVEL_SHORT_WORD ||
               value == CN_LP_LEVEL_SHORT_VALUE)
        LogParams[CN_LP_LEVEL] = CN_LP_LEVEL_SHORT_WORD;
      else if (value == CN_LP_LEVEL_MEDIUM_WORD ||
               value == CN_LP_LEVEL_MEDIUM_VALUE)
        LogParams[CN_LP_LEVEL] = CN_LP_LEVEL_MEDIUM_WORD;
      else if (value == CN_LP_LEVEL_FULL_WORD ||
               value == CN_LP_LEVEL_FULL_VALUE)
    ...
    if (!element) {
      std::cout << "Warning! No '" << CNS_TAG_LOGPATH
                << "' tag found in XML file." << std::endl;
      std::cout << "Value of '" << CNS_TAG_LOGPATH
                << "' tag was defined to 'current directory'." << std::endl;
    } else if (!element->GetText()) {
      std::cout << "Warning! Value of '" << CNS_TAG_LOGPATH
                << "' tag is missing!" << std::endl;
      std::cout << "Value of '" << CNS_TAG_LOGPATH
                << "' tag was defined to 'current directory'." << std::endl;
    } else {
    ...
    if (!element) {
      std::cout << "Warning! No '" << CNS_TAG_LOGFN
                << "' tag found in XML file!" << std::endl;
      std::cout << "Value of '" << CNS_TAG_LOGFN
                << "' tag was defined to default (original filename +'_log' + "
